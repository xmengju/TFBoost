...
We load the data, plot the first 10 predictor curves, and the demand in 638 days. 
...
for(dd in 1:4){
  ...
  model_TFBoost_list[[dd]] <- TFBoost(x_train = xtrain, y_train = ytrain,  x_val = xval,  y_val = yval, 
                              ...
                              shrinkage = shrinkage, nknot = nknot, loss = loss, trace = TRUE))
